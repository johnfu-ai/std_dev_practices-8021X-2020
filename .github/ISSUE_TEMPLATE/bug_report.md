---
name: Bug Report
about: Report a bug or unexpected behavior in the IEEE 802.1X-2020 library
title: '[BUG] '
...
**Library Version:**
- IEEE 802.1X-2020 library version: (e.g., 1.0.0-MVP)
...
- Protocol transport: [ ] Layer 2 [ ] UDP/IPv4 [ ] UDP/IPv6 [ ] Other
...
**Protocol status output** (if applicable):
```bash
# Linux example:
...
- Protocol performance: (describe observed vs expected)
