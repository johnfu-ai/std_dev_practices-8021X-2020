...
> - Root instructions: `ai/instructions/root.instructions.md` (Issue-Driven Development section)
> - Phase instructions: `ai/instructions/phase-NN-*.instructions.md`
...
- **AI-Friendliness**: Optimize for AI coding agents
...
2. Use your AI chat tool or invoke this prompt
