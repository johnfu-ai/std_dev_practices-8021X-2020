 ...
 * 
 * @implements #145 REQ-F-AUTH-001: User Login
 * @see https://github.com/wpa_supplicant/wpa_supplicant-8021X-2020/issues/145
 */
...
- **Copilot Instructions**: `ai/instructions/root.instructions.md` (enforces issue workflow)
- **Test Instructions**: `ai/instructions/tests.instructions.md`
