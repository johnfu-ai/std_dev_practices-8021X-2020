...
|-------------|-------|---------------|---------------|
| **IEEE/ISO/IEC Standards** | Process compliance | 9-phase lifecycle, traceability, verification | `ai/instructions/root.instructions.md` |
...
|-------|---------|-----------------|
| `ai/instructions/root.instructions.md` | Root framework instructions | All developers |
