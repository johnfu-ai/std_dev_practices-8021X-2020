...
> - See: Phase-specific instructions in `ai/instructions/phase-NN-*.instructions.md`
> 
...
**Generated**: D:\Repos\wpa_supplicant-8021X-2020
...
**Questions?** Open an issue or consult the phase-specific copilot instructions in `ai/instructions/`.
