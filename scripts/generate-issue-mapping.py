...
def extract_requirement_id(title: str) -> str | None:
    ...
    """
    # Match patterns: REQ-F-001, StR-001, REQ-PPS-001, REQ-STK-XXX-001, etc.
...
def main():
    ...
    repo_full_name = os.environ.get('GITHUB_REPOSITORY', 'wpa_supplicant/wpa_supplicant-8021X-2020')
