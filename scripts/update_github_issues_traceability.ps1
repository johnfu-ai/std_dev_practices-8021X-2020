...
$repo = "wpa_supplicant-8021X-2020"
...
function Add-TraceabilityComment {
    ...
    $body += "### References`n"
    $body += "- **Standards**: ISO/IEC/IEEE 29148:2018, IEEE 802.1X-2020`n"
...
$issues = @(
    @{N=16; Req="REQ-STK-XXX-NNN"; Spec="✅ STR-PERF-002"; Parent="-"; Child="REQ-SYS-XXX-NNN, REQ-SYS-XXX-NNN"; ADR="-"; ARC="-"; QA="-"; TEST="-"},
    @{N=17; Req="REQ-STK-XXX-NNN"; Spec="✅ STR-PORT-001"; Parent="-"; Child="REQ-SYS-XXX-NNN"; ADR="-"; ARC="-"; QA="-"; TEST="-"},
    @{N=18; Req="REQ-STK-XXX-NNN"; Spec="✅ STR-PERF-001"; Parent="-"; Child="REQ-SYS-XXX-NNN"; ADR="-"; ARC="-"; QA="-"; TEST="-"},
    @{N=19; Req="REQ-STK-XXX-NNN"; Spec="✅ STR-PERF-003"; Parent="-"; Child="-"; ADR="-"; ARC="-"; QA="-"; TEST="-"},
    @{N=20; Req="REQ-STK-XXX-NNN"; Spec="❌ None (Post-MVP)"; Parent="-"; Child="REQ-SYS-XXX-NNN"; ADR="-"; ARC="-"; QA="-"; TEST="-"},
    @{N=21; Req="REQ-STK-XXX-NNN"; Spec="✅ STR-SEC-001"; Parent="-"; Child="REQ-SYS-XXX-NNN"; ADR="-"; ARC="-"; QA="-"; TEST="-"},
    @{N=22; Req="REQ-STK-XXX-NNN"; Spec="❌ None (Post-MVP)"; Parent="-"; Child="REQ-SYS-XXX-NNN"; ADR="-"; ARC="-"; QA="-"; TEST="-"},
    @{N=34; Req="REQ-SYS-XXX-NNN"; Spec="❌ None (Post-MVP)"; Parent="#19 (REQ-STK-XXX-NNN), #20 (REQ-STK-XXX-NNN)"; Child="-"; ADR="ADR-013"; ARC="ARCH-XXX-NNN"; QA="-"; TEST="-"},
    @{N=35; Req="REQ-SYS-XXX-NNN"; Spec="✅ STR-PERF-002"; Parent="#16, #24, #28, #30, REQ-NF-P-002"; Child="-"; ADR="-"; ARC="ARCH-XXX-NNN"; QA="-"; TEST="TEST-XXX-NNN"},
    @{N=36; Req="REQ-SYS-XXX-NNN"; Spec="✅ STR-PERF-001"; Parent="#18, REQ-NF-P-001, REQ-F-003, REQ-F-004"; Child="-"; ADR="-"; ARC="ARCH-XXX-NNN"; QA="-"; TEST="TEST-XXX-NNN"},
    @{N=42; Req="REQ-SYS-XXX-NNN"; Spec="✅ STR-PORT-001"; Parent="#17, #26, REQ-F-005, REQ-NF-M-001"; Child="-"; ADR="ADR-001"; ARC="ARCH-XXX-NNN"; QA="-"; TEST="-"}
)
