...
- [ ] `ai/prompts/` folder exists with Issue-Driven prompts
...
- [ ] **Copilot-Generated Documentation**: Files with Copilot signatures
  - Headers: "Generated by AI Assistant", "AI Chat Session"
...
| ai/prompts/ | [path or MISSING] | ✅/🟡/🔴 | [description] |
...
1. **Repository Structure**
   ...
   - Set up ai/prompts/ with essential prompts
